...
public class EmployeeController {
    ...
    @GetMapping("/employees/job-position/{jobPosition}")
    public ResponseData getByJobPosition(@PathVariable String jobPosition) {
        List<Employee> list = service.getByJobPosition(jobPosition);
        if (!list.isEmpty())
            return new ResponseData(HttpStatus.OK.toString(),
                    true, list);
        else return new ResponseData(HttpStatus.NOT_FOUND.toString(),
    ...
    public ResponseData getByPhone(@PathVariable String Phone) {
        List<Employee> list = service.getByPhone(Phone);
        if (!list.isEmpty())
            return new ResponseData(HttpStatus.OK.toString(),
                    true, list);
        else return new ResponseData(HttpStatus.NOT_FOUND.toString(),
